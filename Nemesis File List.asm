...
; ---------------------------------------------------------------------------
		...
		nemesis Nem_PurpleRock,"GHZ Purple Rock"
		nemesis Nem_GhzSmashWall,"GHZ Smashable Wall"
		nemesis Nem_GhzEdgeWall,"GHZ Walls"
		nemesis Nem_GhzUnkLog,"Unused - GHZ Log"
		...
		nemesis Nem_LzHalfBlock,"LZ 32x16 Block"
		nemesis Nem_LzDoorV,"LZ Vertical Door"
		nemesis Nem_Harpoon,"LZ Harpoon"
		nemesis Nem_LzPole,"LZ Breakable Pole"
		nemesis Nem_LzDoorH,"LZ Horizontal Door"
		nemesis Nem_LzWheel,"LZ Wheel"
		nemesis Nem_Gargoyle,"LZ Gargoyle & Fireball"
		nemesis Nem_LzPlatform,"LZ Rising Platform"
		nemesis Nem_Cork,"LZ Cork"
		nemesis Nem_LzBlock,"LZ 32x32 Block"
		nemesis Nem_Sbz3HugeDoor,"SBZ3 Huge Sliding Door"
		...
		nemesis Nem_MzUnkGrass,"Unused - MZ Grass"
		...
		; SBZ
		nemesis Nem_SbzDisc,"SBZ Running Disc"
		nemesis Nem_SbzJunction,"SBZ Junction Wheel"
		nemesis Nem_Cutter,"SBZ Pizza Cutter"
		nemesis Nem_Stomper,"SBZ Stomper"
		nemesis Nem_SpinPlatform,"SBZ Spinning Platform"
		...
		nemesis Nem_SbzDoorV,"SBZ Small Vertical Door"
		nemesis Nem_SlideFloor,"SBZ Sliding Floor Trap"
		nemesis Nem_SbzDoorH,"SBZ Large Horizontal Door"
