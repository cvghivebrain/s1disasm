...
@size:		equ 16						; number of tiles per frame
		...
		locVRAM	$7000
		lea	(v_ghz_flower_buffer+$400).w,a1		; load special flower patterns (from RAM)
		lea	(a1,d0.w),a1				; jump to appropriate tile
		move.w	#@size-1,d1
		bra.w	LoadTiles
; ===========================================================================
...
@loadTiles:
		...
		ori.w	#$4000,d0
		swap	d0
		; Send VDP command (write to VRAM at address contained in v_giantring_gfx_offset)
		move.l	d0,4(a6)
