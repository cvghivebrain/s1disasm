...
ost_boss_beaten_flag:	equ ost_boss_wait_time+1		; $3D ; $FF = boss is beaten
; ===========================================================================
...
BLZ_Update_SkipPos:
		tst.b	ost_boss_beaten_flag(a0)		; has boss been beaten? (and points received)
...
.beaten:
		...
		move.b	#-1,ost_boss_beaten_flag(a0)		; set beaten flag
		rts	
; ===========================================================================
...
BLZ_ShipMove3:
		...
		tst.b	ost_boss_beaten_flag(a0)		; has boss been beaten?
